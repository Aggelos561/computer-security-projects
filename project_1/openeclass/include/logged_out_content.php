...
if (mysql_num_rows($result) > 0) {
	...
	for($i=0; $i < $numOfAnnouncements; $i++) {
		...
		$announceArr[$i][0] = htmlspecialchars($announceArr[$i][0], ENT_QUOTES, 'UTF-8');
		$announceArr[$i][1] = htmlspecialchars($announceArr[$i][1], ENT_QUOTES, 'UTF-8');
		$announceArr[$i][2] = htmlspecialchars($announceArr[$i][2], ENT_QUOTES, 'UTF-8');
		$announceArr[$i][3] = htmlspecialchars($announceArr[$i][3], ENT_QUOTES, 'UTF-8');
