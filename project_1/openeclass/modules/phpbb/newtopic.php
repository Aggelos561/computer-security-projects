...
// sqli
$prepared = new mysqli($mysqlServer, $mysqlUser, $mysqlPassword, $currentCourseID);
mysqli_set_charset($prepared, "utf8");

$stmt = $prepared->prepare("SELECT forum_name, forum_access, forum_type FROM forums WHERE (forum_id = ?)");
