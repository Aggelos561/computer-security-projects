...
$registration_errors = array();
    ...
    if (count($registration_errors) == 0) {    // registration is ok
            ...
            $prenom_form = mysql_escape_string(htmlspecialchars($prenom_form, ENT_QUOTES, 'UTF-8'));
            $nom_form = mysql_escape_string(htmlspecialchars($nom_form, ENT_QUOTES, 'UTF-8'));
            $uname = mysql_escape_string(htmlspecialchars($uname, ENT_QUOTES, 'UTF-8'));
            $email_form = mysql_escape_string(htmlspecialchars($email_form, ENT_QUOTES, 'UTF-8'));
            $department = mysql_escape_string(htmlspecialchars($department, ENT_QUOTES, 'UTF-8'));
            $userphone = mysql_escape_string(htmlspecialchars($userphone, ENT_QUOTES, 'UTF-8'));
            $usercomment = mysql_escape_string(htmlspecialchars($usercomment, ENT_QUOTES, 'UTF-8'));
            $proflang = mysql_escape_string(htmlspecialchars($proflang, ENT_QUOTES, 'UTF-8'));
