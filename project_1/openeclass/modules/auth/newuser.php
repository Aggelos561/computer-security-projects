...
if (!isset($submit)) {
	...
	$email = mysql_escape_string(htmlspecialchars($email, ENT_QUOTES, 'UTF-8'));
	$department = mysql_escape_string(htmlspecialchars($department, ENT_QUOTES, 'UTF-8'));
	$am = mysql_escape_string(htmlspecialchars($am, ENT_QUOTES, 'UTF-8'));
	$lang = mysql_escape_string(htmlspecialchars($lang, ENT_QUOTES, 'UTF-8'));
