...
if (isset($_POST['submit'])) {
        ...
        if (empty($_POST['title'])) {
                ...
                $updated_title = mysql_escape_string(htmlspecialchars($_POST['title'], ENT_QUOTES, 'UTF-8'));
                
                $title = mysql_escape_string(htmlspecialchars($_POST['title'], ENT_QUOTES, 'UTF-8'));
                $course_keys = mysql_escape_string(htmlspecialchars($_POST['course_keywords'], ENT_QUOTES, 'UTF-8'));
                $course_tuts = mysql_escape_string(htmlspecialchars($_POST['titulary'], ENT_QUOTES, 'UTF-8'));
                ...
                db_query("UPDATE `$mysqlMainDb`.cours
                          SET intitule = " . autoquote($title) .",
                              ...
                              course_keywords = ".autoquote($course_keys) . ",
                              visible = " . intval($_POST['formvisible']) . ",
                              titulaires = " . autoquote($course_tuts) . ",
