...
if (isset($_POST['create_course'])) {
		...
		$intitule =  mysql_escape_string(htmlspecialchars($intitule, ENT_QUOTES, 'UTF-8'));
		$titulaires = mysql_escape_string(htmlspecialchars($titulaires, ENT_QUOTES, 'UTF-8'));

		$description = htmlspecialchars($description, ENT_QUOTES, 'UTF-8');
		$course_keywords = mysql_escape_string(htmlspecialchars($course_keywords, ENT_QUOTES, 'UTF-8'));

		$facname = mysql_escape_string(htmlspecialchars($facname, ENT_QUOTES, 'UTF-8'));

		$course_addon = mysql_escape_string(htmlspecialchars($course_addon, ENT_QUOTES, 'UTF-8'));
		$type = mysql_escape_string(htmlspecialchars($type, ENT_QUOTES, 'UTF-8'));
