...
if (isset($submit) && (!isset($ldap_submit)) && !isset($changePass)) {
	...
	// everything is ok
		...
		// maybe sqli fix
		$username_form = mysql_escape_string(htmlspecialchars($username_form, ENT_QUOTES, 'UTF-8'));
		...
		$am_form = mysql_escape_string(htmlspecialchars($am_form, ENT_QUOTES, 'UTF-8'));
