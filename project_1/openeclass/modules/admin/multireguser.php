...
if (isset($_POST['submit'])) {
        ...
        $user_info = htmlspecialchars($_POST['user_info'], ENT_QUOTES, 'UTF-8');
        $line = strtok($user_info, "\n");
        ...
        while ($line !== false) {
                ...
                if (!empty($line)) {
                        ...
                        if (count($user) >= $numfields) {
                                ...
                                $newstatut = htmlspecialchars($newstatut, ENT_QUOTES, 'UTF-8');
                                if (!isset($info['username'])) {
  
                                        $nom = htmlspecialchars($nom, ENT_QUOTES, 'UTF-8');
                                        $prenom = htmlspecialchars($prenom, ENT_QUOTES, 'UTF-8');
                                        $user_prefix = htmlspecialchars($_POST['prefix'], ENT_QUOTES, 'UTF-8');
                                ...
                                $username = htmlspecialchars($info['username'], ENT_QUOTES, 'UTF-8');
                                $last_info = htmlspecialchars(@$info['last'], ENT_QUOTES, 'UTF-8');
                                $first_info = htmlspecialchars(@$info['first'], ENT_QUOTES, 'UTF-8');
                                $email_info = htmlspecialchars(@$info['email'], ENT_QUOTES, 'UTF-8');
                                $phone_info = htmlspecialchars(@$info['phone'], ENT_QUOTES, 'UTF-8');
