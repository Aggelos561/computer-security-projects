...
// Delete course
if (isset($_GET['delete']) && isset($_GET['c']) && isset($token))  {
	validateToken($token);
	db_query("DROP DATABASE `".mysql_real_escape_string($_GET['c'])."`");
        mysql_select_db($mysqlMainDb);
        $code = quote(mysql_real_escape_string($_GET['c']));
...
// Display confirmatiom message for course deletion
	...
	$tool_content .= "  <tr>
    <td><ul><li><a href=\"".$_SERVER['PHP_SELF']."?c=".htmlspecialchars($_GET['c'])."&amp;delete=yes&csrf_token=".$token."".$searchurl."\"><b>$langYes</b></a><br />&nbsp;</li>
