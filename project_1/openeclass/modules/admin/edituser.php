 ...
 <tr>
  ...
  <tr>
    <td colspan='2'>&nbsp;</td>
		...
		$lname = isset($_POST['lname'])? htmlspecialchars($_POST['lname'], ENT_QUOTES, 'UTF-8'):'';

		// trim white spaces in the end and in the beginning of the word
		$username = preg_replace('/\ +/', ' ', trim(isset($_POST['username'])? htmlspecialchars($_POST['username'], ENT_QUOTES, 'UTF-8'):''));
		$email = isset($_POST['email'])? htmlspecialchars($_POST['email'], ENT_QUOTES, 'UTF-8'):'';
		$phone = isset($_POST['phone'])? htmlspecialchars($_POST['phone'], ENT_QUOTES, 'UTF-8'):'';
		$am = isset($_POST['am'])? htmlspecialchars($_POST['am'], ENT_QUOTES, 'UTF-8'):'';
		$department = isset($_POST['department'])? htmlspecialchars($_POST['department'], ENT_QUOTES, 'UTF-8'):'NULL';
